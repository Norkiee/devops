...
This repo was split from the AI-based **TaskScribe** tool (now a separate project). It keeps the original Vercel deployment, Entra/Azure app registration, and Neon database. All Claude/AI generation has been removed.
